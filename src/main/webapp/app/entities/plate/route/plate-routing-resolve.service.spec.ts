...
describe('Plate routing resolve service', () => {
  ...
  let resultPlate: IPlate | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IPlate returned by find', () => {
      ...
      expect(resultPlate).toEqual({ id: 'ABC' });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPlate).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPlate>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 'ABC' };
